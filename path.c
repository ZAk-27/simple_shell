...
/**
 * create_new_entry - Initializing a new envir variable,
 * @name: variable name
...
/**
 * _new_environ - Initializing a new environment variable,
...
/**
 * _setenv - Initializing or modifying a new environment variable
 * @d: to use the flag
 * @name: variable name
 * @value: variable value
 * Return: void
